    ...
    <head>
        ...
        switch ($controller) {
            case "gst" || "company" || "customer":
                ...
                <link href="<?php echo THEMEURL; ?>plugins/select2/select2.css" rel="stylesheet">
        ...
        <link href="<?php echo ASSETURL; ?>css/custom.css" rel="stylesheet" type="text/css" />
