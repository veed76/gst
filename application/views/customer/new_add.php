...
<div class="row">
        <div class="col-sm-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>
                            <a href="<?php echo base_url(); ?>customer">Register</a>
                    </li>
                    <li class="active">
                         New
                    </li>
    ...
    <div class="col-sm-12">
        <div class="card-box">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control " name="customer_fname" required="" placeholder="First Name">
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control " name="customer_mname"  placeholder="Middle Name">
                </div>
                <div class="col-sm-2">
                    <input type="text" class="form-control " name="customer_lname" required="" placeholder="Last Name">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input parsley-trigger="change" type="text" name="pincode"  maxlength="6" class="form-control"  placeholder="Pincode" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                        <input type="email" data-parsley-id="3"  class="form-control" name="email"  parsley-trigger="change" placeholder="E-mail" />
                </div>
            </div>
                ...
                <div class="col-sm-6">
                    <select class="form-control select2" name="state" required placeholder="State">
                        ...
                        <?php
                            ...
                            {
                                echo "<option value='$val[city_id]-$val[state_code]'>$val[city_name] - $val[city_state]</option>";
                            }
                        ?>
                    </select>
                </div>
